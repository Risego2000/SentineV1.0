...
const ICON_MAP: Record<string, LucideIcon | React.ComponentType<LucideProps>> = {
  'seguridad-protocolo-full': Zap,
  'seguridad-stop-falso': Octagon,
  'seguridad-ceda-paso': AlertTriangle,
  'seguridad-paso-peatones': Accessibility,
  'seguridad-semaforo-rojo': CircleAlert,
  'seguridad-giro-prohibido': Ban,
  'seguridad-direccion-obligatoria': ArrowRight,
  'seguridad-sentido-contrario': ArrowLeft,
  'infraccion-doble-fila': ParkingSquareOff,
  'infraccion-bloqueo-cruce': Grid2x2,
  'infraccion-carril-bus': Bus,
  'arcen-emergencia': AlertTriangle,
  'daganzo-m100-autovia': Minus,
  'roi-general-demo': Target,
  'roi-turn-demo': Ban,
};
