        ...
        <button
          ...
          className={`relative group p-2 rounded-[12px] transition-all duration-500 ${
            isListening
              ...
              : 'bg-slate-900 border border-white/5 text-slate-500 hover:border-cyan-500/50 hover:bg-slate-800'
          }`}
          {...helpProps(
            isListening
      ...
      <div className="bg-slate-900/40 border border-white/10 rounded-[20px] p-4 shadow-2xl relative overflow-hidden group">
        ...
        <div className="relative z-10 space-y-3">
          ...
          <textarea
            ...
            className="w-full h-40 bg-[#020617]/40 border border-white/5 rounded-[15px] p-4 text-[10px] font-mono text-cyan-200/80 outline-none resize-none shadow-inner focus:border-cyan-500/30 focus:bg-[#020617]/60 transition-all uppercase custom-scrollbar placeholder:text-slate-800 leading-relaxed tracking-wider"
