...
1. El usuario invoca el comando `/cc-skill-strategic-compact`.
2. El agente activa la habilidad ubicada en `.agent/skills/awesome_skills/cc-skill-strategic-compact`.
