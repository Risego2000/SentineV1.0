...
1. El usuario invoca el comando `/internal-comms-anthropic`.
2. El agente activa la habilidad ubicada en `.agent/skills/awesome_skills/internal-comms-anthropic`.
