...
1. El usuario invoca el comando `/brand-guidelines-anthropic`.
2. El agente activa la habilidad ubicada en `.agent/skills/awesome_skills/brand-guidelines-anthropic`.
