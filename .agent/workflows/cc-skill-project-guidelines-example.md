...
1. El usuario invoca el comando `/cc-skill-project-guidelines-example`.
2. El agente activa la habilidad ubicada en `.agent/skills/awesome_skills/cc-skill-project-guidelines-example`.
